# TESTS COMMENTED OUT UNTIL ROUTE IS BUILT

# import pytest
# from playwright.sync_api import Page, expect


# def test_page_title_and_main_heading(page: Page):
#     expect(page).to_have_title("Makersbnb")

#     logo_text = page.locator(".logo p")
#     expect(logo_text).to_have_text("makersbnb")

#     main_heading = page.get_by_role("heading", name="Welcome to the Neighborhood")
#     expect(main_heading).to_be_visible()


# def test_navigation_links(page: Page):
#     """Verifies the presence and correct attributes of the navigation links."""

#     sign_up_link = page.get_by_role("link", name="Log in")
...
#     email_input = page.get_by_label("Full Name")
#     expect(email_input).to_be_visible()
#     expect(email_input).to_have_attribute("name", "name")
...
#     login_button = page.get_by_role("button", name="Sign-up")
#     expect(login_button).to_be_visible()
#     expect(login_button).to_have_attribute("type", "submit")


# def test_can_fill_and_submit_form(page: Page):
...
#     expect(page.get_by_label("Full Name")).to_have_value(test_name)
...
# def test_footer_contains_copyright(page: Page):
#     """Ensures the footer is present and contains the copyright notice."""
